...
public class Compression {
     ...
     */
    public static String getCompressionExcludeKey(final Request request) {
     ...
     * "minifymod.compress.exclude.action." + action
     */
    public static String getCompressionExcludeKey(final String action) {
     ...
     */
    public static boolean isExcludedAction(final Request request) {
     ...
     */
    public static boolean isExcludedAction(final String action) {
     ...
     */
    public static void excludeAction(final String action) {
